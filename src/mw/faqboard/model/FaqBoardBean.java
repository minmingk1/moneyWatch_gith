...
public class FaqBoardBean {
	...
	@RequestMapping("faqList.mw") //FAQ 게시판,유저게시판 출력
	...
	@RequestMapping("content.mw") //���� �Խ��� �Խñۼ��� ����
	...
	@RequestMapping("faqQwriteForm.mw") //FAQ (����ã�� ����) �۾���
	...
	@RequestMapping("faqQwritePro.mw") //FAQ �۾��� ����
	...
	@RequestMapping("faqContent.mw") //FAQ �Խñ� ��
	...
	@RequestMapping("faqMainUpdateForm.mw") //FAQ �Խñ� ����
	...
	@RequestMapping("faqMainUpdatePro.mw") //FAQ �Խñ� ���� ����
	...
	@RequestMapping("faqMainDelete.mw") //FAQ �Խñ� ����
	...
	@RequestMapping("faqMainDeletePro.mw") //FAQ �Խñ� ���� ����
